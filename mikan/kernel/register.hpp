 ...
 * with specific bit wedth. The bit width will be deduced from the type of 
 ...
 * should have Size() method andIterator type.
 * Size() should return the number of elements, and iterators
 * of that type shold iterate all elements.
 * 
